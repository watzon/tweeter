...
describe Tweeter::Tweet do
  describe "#==" do
    it "returns true when object's IDs are the same" do
      tweet = Tweeter::Tweet.new(id: 1, text: "foo")
      other = Tweeter::Tweet.new(id: 1, text: "bar")
      expect(tweet == other).to be_true
    end

    it "returns false when object's IDs are different" do
      tweet = Tweeter::Tweet.new(id: 1)
      other = Tweeter::Tweet.new(id: 2)
  ...
  describe "#created_at" do
    it "returns a Time when set" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, created_at: Time.now)
      expect(tweet.created_at).to be_a Time
    end

    it "returns nil when not set" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014)
  ...
  describe "#entities?" do
    it "returns true if there are any entities set" do
      ...
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, entities: entities)
      expect(tweet.entities?).to be_true
    end

    it "returns false if entities is a blank list" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, entities: Tweeter::Entities.new)
  ...
  describe "#filter_level" do
    it "returns the filter level when filter_level is set" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, filter_level: "high")
  ...
  describe "#full_text" do
    it "returns the text of a Tweet" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, text: "BOOSH")
      expect(tweet.full_text).to be_a String
      expect(tweet.full_text).to eq("BOOSH")
    end

    it "returns the text of a Tweet without a user" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, text: "BOOSH", retweeted_status: Tweeter::Tweet.new(id: 28_561_922_517, text: "BOOSH"))
      expect(tweet.full_text).to be_a String
      expect(tweet.full_text).to eq("BOOSH")
    end

    it "returns the full text of a retweeted Tweet" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, text: "RT @watzon: BOOSH", retweeted_status: Tweeter::Tweet.new(id: 540_897_316_908_331_009, text: "BOOSH"))
      expect(tweet.full_text).to be_a String
  ...
  describe "#coordinates" do
    it "returns a Twitter::Coordinates::Point when coordinates is set" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, coordinates: Tweeter::Coordinates::Point.new)
  ...
  describe "#coordinates?" do
    ...
    it "returns false when coordinates is the wrong type" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, coordinates: Tweeter::Coordinates.new)
      expect(tweet.coordinates?).to be_false
    end
  end
  ...
  describe "#hashtags" do
    context "entities_set" do
      ...
      subject do
        Tweeter::Tweet.new(id: 28_669_546_014, entities: Tweeter::Entities.new(hashtags: hashtags_array))
      end
    ...
    context "entities_set_but_empty" do
      subject do
        Tweeter::Tweet.new(id: 28_669_546_014, entities: Tweeter::Entities.new(hashtags: [] of Tweeter::Entity::Hashtag))
      end
    ...
    context "entities_not_set" do
      subject do
        Tweeter::Tweet.new(id: 28_669_546_014)
      end
  ...
  describe "#media" do
    it "returns media" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, entities: Tweeter::Entities.new(media: [Tweeter::Entity::Media.new(id: 1, type: "photo")]))
  ...
  describe "#metadata" do
    it "returns a Tweeter::Metadata when metadata is set" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, metadata: Tweeter::Metadata.new(result_type: "recent"))
  ...
  describe "#place" do
    it "returns a Tweeter::Place when place is set" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, place: Tweeter::Place.new(id: "247f43d441defc03"))
  ...
  describe "#reply?" do
    it "returns true when there is an in-reply-to user" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, in_reply_to_user_id: 7_505_382)
  ...
  describe "#retweet?" do
    it "returns true when retweeted_status is set" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, retweeted_status: Tweeter::Tweet.new(id: 540_897_316_908_331_009, text: "BOOSH"))
  ...
  describe "#quoted_status" do
    it "returns a Tweet when quoted_status is set" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, quoted_status: Tweeter::Tweet.new(id: 540_897_316_908_331_009, text: "BOOSH"))
  ...
  describe "#uri" do
    it "returns the URI to the tweet" do
      tweet = Tweeter::Tweet.new(id: 955_689_420_035_825_664, user: Tweeter::User.new(id: 2_252_786_816, screen_name: "_watzon"))
  ...
  describe "#user" do
    it "returns a User when user is set" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, user: Tweeter::User.new(id: 2_252_786_816))
    ...
    pending "has a status set" do
      tweet = Tweeter::Tweet.new(id: 28_669_546_014, text: "Tweet text.", user: Tweeter::User.new(id: 2_252_786_816))
      user = tweet.user.not_nil!
      expect(user.status).to be_a Tweeter::Tweet
      expect(user.status.id).to eq(28_669_546_014)
    end
  end
  ...
  describe "#user_mentions" do
    it "returns an array of Entity::UserMention when entities are set" do
      ...
      expect(tweet.user_mentions.first.id).to eq(2_252_786_816)
    end
