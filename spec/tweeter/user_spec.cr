...
describe Tweeter::User do
  describe "#==" do
    it "returns true when object IDs are the same" do
      user = Tweeter::User.new(id: 1, screen_name: "foo")
      other = Tweeter::User.new(id: 1, screen_name: "bar")
      expect(user == other).to be_true
    end

    it "returns false when object IDs are different" do
      user = Tweeter::User.new(id: 1)
      other = Tweeter::User.new(id: 2)
  ...
  describe "#created_at" do
    ...
    it "returns nil when created_at is not set" do
      user = Tweeter::User.new(id: 2_252_786_816)
  ...
  describe "#description_urls" do
    it "returns an array of Entity::URLs when description URL entities are set" do
      ...
      user = Tweeter::User.new(id: 2_252_786_816, entities: entities)
  ...
  describe "#url" do
    it "returns the URL to the user" do
      user = Tweeter::User.new(id: 2_252_786_816, screen_name: "_watzon")
  ...
  describe "#website" do
    it "returns a URI when the url is set" do
      user = Tweeter::User.new(id: 2_252_786_816, url: URI.parse("https://watzon.me"))
